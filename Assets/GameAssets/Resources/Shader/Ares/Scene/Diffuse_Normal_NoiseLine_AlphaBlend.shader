Shader "Ares/Scene/Diffuse_Normal_NoiseLine_AlphaBlend"
{
	Properties
	{
	...
	SubShader
	{
        ...
        Tags { "Queue" = "Transparent-10" "RenderType"="Opaque" "GonbestBloomType"="BloomMask"}        
		LOD 250
		UsePass "Gonbest/PBR/ScenePBRHelper/LIGHTMAP&ALPHABLEND&NOISELIGHTLINE"		
	}
	...
	SubShader
	{
        ...
        Tags { "Queue" = "Transparent-10" "RenderType"="Opaque" "GonbestBloomType"="BloomMask"}        
		LOD 100
		UsePass "Gonbest/Legacy/SceneHelper/LIGHTMAP&ALPHABLEND"
	}
