Shader "Ares/Scene/NoDiffuse_Normal_NoiseLine_AlphaBlend_RGB" 
{
	Properties
	{
		_Color ("Main Color", Color) = (1, 1, 1, 1)
		_ColorMultiplier("Color Multipler",range(0,2)) = 1
		_MainTex( "Base (RGB)", 2D ) = "(0,0,0,0)" {}
	...
	SubShader
	{
        ...
        Tags { "Queue" = "Transparent-10" "IgnoreProjector"="True" "RenderType"="Transparent" "GonbestBloomType"="BloomMask"}   
		LOD 250
		UsePass "Gonbest/PBR/ScenePBRHelper/NOLIGHTMAP&ALPHABLEND&ALPHATEX&NOISELIGHTLINE"
	}	
	SubShader
	{
		//使用这个Shader的基本上都是贴在地面上的一些透贴,那么就使其提前渲染.不会挡住场景中的一些alpha特效
        Tags { "Queue" = "Transparent-10" "IgnoreProjector"="True" "RenderType"="Transparent" "GonbestBloomType"="BloomMask"}   
		LOD 100
		UsePass "Gonbest/Legacy/SceneHelper/NOLIGHTMAP&ALPHABLEND&ALPHATEX"
	}
