Shader "Ares/Scene/NoDiffuse_Normal_NoiseLine_AlphaBlend" 
{
	Properties
	{
	...
	SubShader
	{
		...
		LOD 250
		UsePass "Gonbest/PBR/ScenePBRHelper/NOLIGHTMAP&ALPHABLEND&NOISELIGHTLINE"
	}	
	...
	SubShader
	{
        ...
        Tags { "Queue" = "Transparent-10" "IgnoreProjector"="True" "RenderType"="Transparent" "GonbestBloomType"="BloomMask"}
		LOD 100
		UsePass "Gonbest/Legacy/SceneHelper/NOLIGHTMAP&ALPHABLEND"
	}
