Shader "Ares/Scene/NoDiffuse_Normal_NoiseLine_AlphaTest_DoubleFace" 
{
	Properties
	{
	...
	SubShader
	{
		...
		LOD 250
		UsePass "Gonbest/PBR/ScenePBRHelper/NOLIGHTMAP&ALPHATEST&NOISELIGHTLINE&DOUBLEFACE"
	}	
	SubShader
	{
        Tags { "Queue" = "AlphaTest" "GonbestBloomType"="BloomMask" }
		LOD 100
		UsePass "Gonbest/Legacy/SceneHelper/NOLIGHTMAP&ALPHATEST&DOUBLEFACE"
	}
