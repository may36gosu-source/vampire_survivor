Shader "Ares/Scene/Diffuse_Normal_NoiseLine_RGB"
{
	Properties
	{
	...
	SubShader
	{
		...
		LOD 250
		UsePass "Gonbest/PBR/ScenePBRHelper/LIGHTMAP&ALPHATEX&NOISELIGHTLINE"
	}	
	...
	SubShader
	{
        Tags { "RenderType"="Opaque"  "GonbestBloomType"="BloomMask"}
		LOD 100
		UsePass "Gonbest/Legacy/SceneHelper/LIGHTMAP&ALPHATEX"
	}
