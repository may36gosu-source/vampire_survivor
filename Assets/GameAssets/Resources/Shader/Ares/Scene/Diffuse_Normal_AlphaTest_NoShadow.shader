Shader "Ares/Scene/Diffuse_Normal_AlphaTest_NoShader" 
{
	Properties
	{
	...
	SubShader
	{
		...
		LOD 250
		CGINCLUDE
			#pragma multi_compile _GONBEST_SHADOW_OFF
			#undef _GONBEST_SHADOW_ON
		ENDCG
		UsePass "Gonbest/PBR/ScenePBRHelper/LIGHTMAP&ALPHATEST&SUNNY_NOSHADOW"
	}
	SubShader
	{
        Tags { "Queue" = "AlphaTest"  "GonbestBloomType"="BloomMask"}
		LOD 100
		UsePass "Gonbest/Legacy/SceneHelper/LIGHTMAP&ALPHATEST"
	}
