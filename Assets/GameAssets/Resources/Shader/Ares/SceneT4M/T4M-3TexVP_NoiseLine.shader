Shader "Ares/SceneT4M/T4M-3TexVP_NoiseLine" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		LOD 250
		UsePass "Gonbest/PBR/T4MPBRHelper/THREE&NOISELINE"
	}     

	SubShader 
	{
		Tags {"SplatCount" = "3" "RenderType" = "Opaque" "Queue" = "Geometry+50"  "GonbestBloomType"="BloomMask"}
		LOD 100
		UsePass "Gonbest/Legacy/T4MHelper/THREE"			
	}	
}
