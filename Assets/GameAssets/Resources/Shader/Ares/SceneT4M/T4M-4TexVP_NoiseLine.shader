Shader "Ares/SceneT4M/T4M-4TexVP_NoiseLine" 
{
	Properties 
	{
		...
		_Splat2_BumpMap ( "Layer 3 Normal Map", 2D ) = "white" {}
		_Splat3_BumpMap ( "Layer 4 Normal Map", 2D ) = "white" {}
	...
	SubShader 
	{
		Tags {"SplatCount" = "4" "RenderType" = "Opaque" "Queue" = "Geometry+50"  "GonbestBloomType"="BloomMask"}	
		LOD 250
		UsePass "Gonbest/PBR/T4MPBRHelper/FOUR&NOISELINE"
	} 
	...
	SubShader 
	{
		Tags {"SplatCount" = "4" "RenderType" = "Opaque" "Queue" = "Geometry+50"  "GonbestBloomType"="BloomMask"}
		LOD 100
		UsePass "Gonbest/Legacy/T4MHelper/FOUR"
	}
