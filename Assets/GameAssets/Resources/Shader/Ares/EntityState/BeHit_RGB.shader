//被击的特效
Shader "Ares/EntityState/BeHit_RGB"
{
	Properties
	{
		_MainTex( "Base( RGB )", 2D ) = "white" {}
		_AlphaTex("alpha (AAA)", 2D) = "white" {}
		_RimColor ("Out Color", Color) = ( 1, 1, 1, 1)
	...
	{
		//LOD 100
		Tags {"Queue" = "AlphaTest+50" "RenderType" = "Opaque" "GonbestBloomType"="BloomMask"}		
		UsePass "Gonbest/Function/RimHelper/RIMLIGHT&SIMPLE"
	}
}
