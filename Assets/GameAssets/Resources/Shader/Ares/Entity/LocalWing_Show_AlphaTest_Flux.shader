Shader "Ares/Entity/LocalWing_Show_AlphaTest_Flux"
{
	Properties
	{
	...
	SubShader
	{
		...
		LOD 250
        UsePass "Gonbest/PBR/BodyPBRHelper/COMMON&ALPHATEST&FLUX"
	}
	SubShader
	{
        Tags {"Queue"="Transparent+50" "IgnoreProjector"="True" "RenderType"= "Opaque" "GonbestBloomType"="BloomMask"}      
	    UsePass "Gonbest/Legacy/BodyHelper/COMMON&ALPHATEST&FLUX"
	}	
