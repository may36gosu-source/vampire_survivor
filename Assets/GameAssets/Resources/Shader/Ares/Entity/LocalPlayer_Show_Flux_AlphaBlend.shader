Shader "Ares/Entity/LocalPlayer_Show_Flux_AlphaBlend"
{
	Properties
	{
	...
	SubShader
	{
        ...
        UsePass "Gonbest/PBR/BodyPBRHelper/COMMON&BLEND&FLUX"
	}	
	...
	{		
		...
		UsePass "Gonbest/Function/ZTestGreaterHelper/XRAY"
		UsePass "Gonbest/Function/DepthHelper/ONLYWRITEDEPTH"       
		UsePass "Gonbest/Legacy/BodyHelper/COMMON&BLEND&FLUX"
	}
