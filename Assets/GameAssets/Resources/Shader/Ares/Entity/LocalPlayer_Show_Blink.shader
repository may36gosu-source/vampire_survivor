Shader "Ares/Entity/LocalPlayer_Show_Blink"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType" = "Opaque" "Queue" = "AlphaTest+50" "GonbestBloomType"="BloomMask"}	
		LOD 250
		UsePass "Gonbest/Function/ZTestGreaterHelper/XRAY"
        UsePass "Gonbest/PBR/BodyPBRHelper/COMMON&BLINK"
	}	
	...
	{		
		Tags { "RenderType" = "Opaque" "Queue" = "AlphaTest+50" "GonbestBloomType"="BloomMask"}	
		UsePass "Gonbest/Function/ZTestGreaterHelper/XRAY"
		UsePass "Gonbest/Legacy/BodyHelper/COMMON&BLINK"
	}
