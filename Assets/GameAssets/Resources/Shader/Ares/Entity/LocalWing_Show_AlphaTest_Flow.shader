Shader "Ares/Entity/LocalWing_Show_AlphaTest_Flow"
{
	Properties
	{
	...
	SubShader
	{
		...
		LOD 250
        UsePass "Gonbest/PBR/BodyPBRHelper/COMMON&ALPHATEST&FLOW"
	}	
	SubShader
	{
        Tags {"Queue"="Transparent+50" "IgnoreProjector"="True" "RenderType"= "Opaque" "GonbestBloomType"="BloomMask"}      
	    UsePass "Gonbest/Legacy/BodyHelper/COMMON&ALPHATEST&FLOW"
	}	
