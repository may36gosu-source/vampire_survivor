Shader "Ares/Entity/LocalPlayer_Show_Flow_AlphaBlend"
{
	Properties
	{
	...
	SubShader
	{
        ...
        UsePass "Gonbest/PBR/BodyPBRHelper/COMMON&BLEND&FLOW"
	}	
	...
	{		
		...
		UsePass "Gonbest/Function/ZTestGreaterHelper/XRAY"
		UsePass "Gonbest/Function/DepthHelper/ONLYWRITEDEPTH"       
		UsePass "Gonbest/Legacy/BodyHelper/COMMON&BLEND&FLOW"
	}
