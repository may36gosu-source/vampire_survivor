Shader "Ares/Entity/Hair_Show"
{
	...
	SubShader
	{
		Tags { "RenderType" = "Opaque" "Queue" = "Transparent" "GonbestBloomType"="BloomMask"}
        UsePass "Gonbest/PBR/NewHairPBRHelper/WRITE&Z&A"
        UsePass "Gonbest/PBR/NewHairPBRHelper/WRITE&RGB&BASE"
        UsePass "Gonbest/PBR/NewHairPBRHelper/WRITE&BLEND&BACK"
        UsePass "Gonbest/PBR/NewHairPBRHelper/WRITE&BLEND&FRONT"		
	}	
