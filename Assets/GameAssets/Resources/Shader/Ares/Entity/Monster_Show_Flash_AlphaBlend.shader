Shader "Ares/Entity/Monster_Show_Flash_AlphaBlend"
{
	Properties
	{
	...
	SubShader
	{
        ...
        UsePass "Gonbest/PBR/BodyPBRHelper/COMMON&FLASH&BLEND"
	}
	...
	SubShader
	{
		Tags {"Queue"="Transparent+50" "IgnoreProjector"="True" "RenderType"= "Opaque" "GonbestBloomType"="BloomMask"}	
		UsePass "Gonbest/Function/DepthHelper/ONLYWRITEDEPTH"       	
		UsePass "Gonbest/Legacy/BodyHelper/COMMON&FLASH&BLEND"
	}		
