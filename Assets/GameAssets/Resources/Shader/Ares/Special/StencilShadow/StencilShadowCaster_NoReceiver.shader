...
Author:gzg
Date:2019-08-20
Desc:这个Shader是用来生成阴影,可以不需要接受者
    本Shader还有两个参数_LightDir向量(光的方向)和_World2Receiver矩阵(世界到投影的面板的转换矩阵),需要通过程序代码设置.
*/
Shader "Ares/SpecialEffect/StencilShadowCaster_NoReceiver"
{
	Properties
	{
	...
	SubShader
	{
		...
		LOD 100
		UsePass "Gonbest/Function/StencilShadowHelper/SHADOWCASTER&WITHOUTRECEIVER&PLANEDIR"
	}
}
