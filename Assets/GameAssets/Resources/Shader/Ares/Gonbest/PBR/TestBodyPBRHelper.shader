...
Shader "Gonbest/PBR/TestBodyPBRHelper"
{
	...
	CGINCLUDE		
		...
		// Define platform check for Snapdragon 8 Gen 2 compatibility
		// No need to define any special symbols - the include file will handle it
	...
	{ 
		...
		{//一个最基本的通用型Pass,非透明
			...
			CGPROGRAM
				...
				#pragma multi_compile _GONBEST_COLOR_MULTIPLIER_ON
				#pragma multi_compile _GONBEST_ENV_MIP_LEVEL_METALIC
				#pragma multi_compile _ _GONBEST_FLOW_ON  // Added space to fix Adreno parsing
