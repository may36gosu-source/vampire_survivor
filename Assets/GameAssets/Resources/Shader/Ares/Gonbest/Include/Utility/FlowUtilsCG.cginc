...
/*******************模型上流光的处理***************************/
// First check if we're on a newer Adreno GPU like Snapdragon 8 Gen 2
#if defined(SHADER_API_GLES3) && !defined(SHADER_API_DESKTOP)
    // Use specialized implementation for Snapdragon 8 Gen 2 and newer
    // Include the specialized compatibility implementation
    #include "FlowUtilsCG_Compat.cginc"

// Standard implementation for other platforms
#elif defined(_GONBEST_FLOW_ON)
...
#else //定义空宏
    // Fallback for platforms with flow effects disabled
