...
////// Emissive:
                ...
                float3 emissive = ((node_2388+floor(node_2388 * _Fenli) / (_Fenli - 1))*_FresnelColor.rgb*_Alpha*i.vertexColor.rgb);
