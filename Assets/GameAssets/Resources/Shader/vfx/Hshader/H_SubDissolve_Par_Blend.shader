...
////// Emissive:
                ...
                float3 node_4485 = saturate(((_TEX_var.rgb*_TEX_var.a)-pow(((1.0 - (_Dssoled_var.rgb*_Dssoled_var.a))*((1.0 - i.vertexColor.a)*_VertexColor_power)),_Power)));
