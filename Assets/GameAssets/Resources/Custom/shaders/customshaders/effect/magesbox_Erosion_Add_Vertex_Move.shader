Shader "magesbox/Erosion_Add_Vertex_Move"
{
  Properties
  {
    ...
    _Erosion_Texure_U ("Erosion_Texure_U", float) = 0
    _Erosion_Texure_V ("Erosion_Texure_V", float) = 0
    _Mask ("Mask", 2D) = "white" {}
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      uniform float _Erosion_Texure_U;
      uniform float _Erosion_Texure_V;
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = ((float2(_Erosion_Texure_U, _Erosion_Texure_V) * _Time.yy) + in_f.texcoord.xy);
          ...
          u_xlat2 = ((in_f.texcoord1.z * u_xlat2) + _Soft_Value);
