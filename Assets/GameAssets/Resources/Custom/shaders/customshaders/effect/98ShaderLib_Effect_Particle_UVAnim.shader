Shader "98ShaderLib/Effect/Particle_UVAnim"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = ((u_xlat0_d.xy * float2(_NosieValue, _NosieValue)) + float2(0, (-0.5)));
          u_xlat14.x = dot(u_xlat0_d.xy, u_xlat0_d.xy);
          u_xlat14.x = rsqrt(u_xlat14.x);
          u_xlat0_d.xy = (u_xlat14.xx * u_xlat0_d.xy);
          #ifdef UNITY_ADRENO_ES3
          u_xlatb14.x = (_NosieValue>=9.99999975E-06);
          #else
          u_xlatb14.x = (_NosieValue>=9.99999975E-06);
          #endif
          u_xlat14.x = (u_xlatb14.x)?(1):(float(0));
          u_xlat0_d.xy = ((u_xlat14.xx * u_xlat0_d.xy) + in_f.texcoord.xy);
          u_xlat14.xy = ((float2(_U_Move_DissolveTex, _V_Move_DissolveTex) * _Time.yy) + u_xlat0_d.xy);
          u_xlat0_d.xy = ((float2(_U_Move_MainTex, _V_Move_MainTex) * _Time.yy) + u_xlat0_d.xy);
          u_xlat14.xy = TRANSFORM_TEX(u_xlat14.xy, _DissolveTex);
          u_xlat16_1 = tex2D(_DissolveTex, u_xlat14.xy);
          u_xlatb14.xy = bool4(float4(_ModifiedByCustomData_Z, _OpenOutLine, _ModifiedByCustomData_Z, _OpenOutLine) >= float4(9.99999975E-06, 0.00100000005, 9.99999975E-06, 0.00100000005)).xy;
          u_xlat14.x = (u_xlatb14.x)?(in_f.texcoord1.x):(_DissolveValue);
          u_xlat21 = (u_xlatb14.y)?(1):(float(0));
          u_xlat2_d.x = ((_OutlineWidth * 2) + u_xlat14.x);
          u_xlat3 = (u_xlat16_1 + (-u_xlat2_d.xxxx));
          u_xlat9 = ((_OutlineWidth * 3) + u_xlat14.x);
          u_xlat2_d.x = ((-u_xlat2_d.x) + u_xlat9);
          u_xlat2_d.x = (float(1) / u_xlat2_d.x);
          u_xlat2_d = (u_xlat2_d.xxxx * u_xlat3);
          #ifdef UNITY_ADRENO_ES3
          u_xlat2_d = min(max(u_xlat2_d, 0), 1);
          #else
          u_xlat2_d = clamp(u_xlat2_d, 0, 1);
          #endif
          u_xlat3 = ((u_xlat2_d * float4(-2, (-2), (-2), (-2))) + float4(3, 3, 3, 3));
          u_xlat2_d = (u_xlat2_d * u_xlat2_d);
          u_xlat4 = ((-u_xlat14.xxxx) + u_xlat16_1);
          u_xlat5.x = (float(1) / _OutlineWidth);
          u_xlat4 = (u_xlat4 * u_xlat5.xxxx);
          #ifdef UNITY_ADRENO_ES3
          u_xlat4 = min(max(u_xlat4, 0), 1);
          #else
          u_xlat4 = clamp(u_xlat4, 0, 1);
          #endif
          u_xlat5 = ((u_xlat4 * float4(-2, (-2), (-2), (-2))) + float4(3, 3, 3, 3));
          u_xlat4 = (u_xlat4 * u_xlat4);
          u_xlat6 = (u_xlat4 * u_xlat5);
          u_xlat4.x = (((-u_xlat5.x) * u_xlat4.x) + 1);
          u_xlat2_d = (((-u_xlat3) * u_xlat2_d) + u_xlat6);
          u_xlat2_d = (u_xlat2_d * _OutlineColor);
          u_xlat2_d = (u_xlat16_1 * u_xlat2_d);
          u_xlat3.w = (_Time.y * _V_Move_Mask);
          u_xlat3.x = (_Time.y * _U_Move_Mask);
          u_xlat3.xy = (u_xlat3.xw + in_f.texcoord.xy);
          u_xlat3.xy = TRANSFORM_TEX(u_xlat3.xy, _Mask);
          u_xlat16_3 = tex2D(_Mask, u_xlat3.xy);
          u_xlat2_d = (u_xlat2_d * u_xlat16_3);
          u_xlat2_d = (float4(u_xlat21, u_xlat21, u_xlat21, u_xlat21) * u_xlat2_d);
          u_xlat2_d = (u_xlat16_1.wwww * u_xlat2_d);
          u_xlat21 = length(u_xlat16_1);
          u_xlat2_d = (float4(u_xlat21, u_xlat21, u_xlat21, u_xlat21) * u_xlat2_d);
          #ifdef UNITY_ADRENO_ES3
          u_xlat2_d = min(max(u_xlat2_d, 0), 1);
          #else
          ...
          #endif
          #ifdef UNITY_ADRENO_ES3
          u_xlatb21 = (_ModifiedByCustomData_ZW>=9.99999975E-06);
          #else
          u_xlatb21 = (_ModifiedByCustomData_ZW>=9.99999975E-06);
          #endif
          u_xlat8.xy = (int(u_xlatb21))?(in_f.texcoord2.xy):(float2(0, 0));
          ...
          u_xlat0_d.xyw = (u_xlat16_5.xyz * _Color.xyz);
          u_xlat0_d.xyw = (u_xlat16_3.xyz * u_xlat0_d.xyw);
          u_xlat6.xyz = (u_xlat0_d.xyw * in_f.color.xyz);
          u_xlat6.w = in_f.color.w;
          u_xlat2_d = ((u_xlat6 * float4(2, 2, 2, 2)) + u_xlat2_d);
          u_xlat0_d.x = ((-_SoftValue) + 1);
          u_xlat7 = ((-u_xlat0_d.x) + (-1.5));
          u_xlat7 = ((u_xlat14.x * u_xlat7) + u_xlat0_d.x);
          u_xlat0_d.x = ((u_xlat16_1.x * u_xlat0_d.x) + (-u_xlat7));
          #ifdef UNITY_ADRENO_ES3
          u_xlat0_d.x = min(max(u_xlat0_d.x, 0), 1);
          #else
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          #endif
          u_xlat0_d.x = (u_xlat16_3.w * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat16_5.w * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat4.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * in_f.color.w);
          u_xlat0_d = (u_xlat0_d.xxxx * u_xlat2_d);
          ...
          #endif
          u_xlat22 = float(_IsClampFinalColor);
          #ifdef UNITY_ADRENO_ES3
          u_xlatb22 = (u_xlat22>=0.00100000005);
          #else
          u_xlatb22 = (u_xlat22>=0.00100000005);
          #endif
          out_f.color.xyz = (int(u_xlatb22))?(u_xlat1_d.xyz):(u_xlat0_d.xyz);
