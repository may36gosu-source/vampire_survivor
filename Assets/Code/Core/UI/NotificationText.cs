...
//     [SerializeField]
//     private float visibleHeight = 170f;

//     [SerializeField]
//     private float fadeDistance = 50f;
...
//         float fadeStart = visibleHeight - fadeDistance;

//         if (position.y >= fadeStart)
//         {
//             float fadeProgress = (position.y - fadeStart) / fadeDistance;

//             canvasGroup.alpha =
//                 Mathf.Clamp01(1f - fadeProgress);
//         }

//         if (position.y >= visibleHeight)
//         {
//             isExpired = true;
//         }
//     }
